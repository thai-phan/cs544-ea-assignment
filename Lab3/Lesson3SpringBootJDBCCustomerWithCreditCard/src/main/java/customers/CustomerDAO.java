...
public class CustomerDAO {
  ...
  public void save(Customer customer) {
    ...
    // save creditcard
    Map<String, Object> namedParametersCC = new HashMap<>();
  ...
  CreditCard getCreditCardForCustomer(int customerNumber) {
    Map<String, Object> namedParameters = new HashMap<>();
    namedParameters.put("customerNumber", customerNumber);
    CreditCard creditCard = jdbcTemplate.queryForObject("SELECT * FROM creditcard WHERE customerNumber =:customerNumber ", namedParameters,
